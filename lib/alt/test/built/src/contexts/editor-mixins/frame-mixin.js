...
exports.FrameMixin = function (superclass) { return (function (_super) {
    ...
    class_1.prototype.replaceIeByLayeredImage = function (layeredImage) {
        ...
        this.ie = image_editor_1.default.create(this.stage, layeredImage.selected, layeredImage.width, layeredImage.height, gen.convertToImage(layeredImage.selected), gen.convertToImage(layeredImage.overlay), gen.convertToImage(layeredImage.underlay));
