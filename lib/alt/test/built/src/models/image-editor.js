...
var ImageEditor = (function (_super) {
    ...
    ImageEditor.create = function (stage, dataURL, w, h, imageElement, overlayElement, underlayElement) {
        return new ImageEditor(stage, dataURL, w, h, imageElement, overlayElement, underlayElement);
    };
