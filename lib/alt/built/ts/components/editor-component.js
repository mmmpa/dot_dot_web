    ...
    EditorComponent.prototype.onWindowResize = function (e) {
        ...
        this.setState({
            layout: {
                ...
                toolSelector: new style_stylist_1.default(left, 0, right, split * 2).css,
                ...
                colorController: new style_stylist_1.default(left, split * 4, right, 140).css,
                modal: new style_stylist_1.default(0, 0, w, h).css
            }
        });
    };
