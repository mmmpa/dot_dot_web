...
var argb_1 = require("../ts/models/argb");
var gradation_color_1 = require('../ts/models/gradation-color');
describe('Card', function () {
    describe('作成', function () {
        it('グラデーションの数', function () {
            var g = new gradation_color_1.default(undefined, undefined, 10);
            assert.ok(g.colors.length === 10);
        });
        it('グラデーションの変化', function () {
            var g = new gradation_color_1.default(new argb_1.default(255, 1, 1, 1), new argb_1.default(255, 10, 10, 10), 10);
